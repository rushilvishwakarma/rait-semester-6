...
<Cards>
  <Card 
    ...
    href="https://drive.google.com/file/d/1VNbUYzLDfAAGKJIPkEp7j8KXy9DKBccZ/view?usp=sharing"
  />
  <Card 
    icon={<Download />}
    title="Exp3 ipynb file" 
    description="View Notebook in Drive"
    href="https://drive.google.com/file/d/13z-XAzWHa-KJJEM8RaBd47_nr3u0tbvP/view?usp=sharing"
  />
</Cards>

## Experiment No. 3: Implement Factor Analysis for any real world problem

This experiment focuses on implementing Factor Analysis for any real world problem. Use the provided journal and notebook resources above for guidance and reference.
