...
<Cards>
  <Card 
    ...
    href="https://drive.google.com/file/d/1knnpBs5T5YTz1O42zw3ZyNPT9O7J5mgc/view?usp=sharing"
  />
  <Card 
    icon={<Download />}
    title="Exp4 ipynb file" 
    description="View Notebook in Drive"
    href="https://drive.google.com/file/d/1TeHxQHdVd91VdJuSauBR6GYPTfN_KWC6/view?usp=sharing"
  />
</Cards>

## Experiment No. 4: Implement EM algorithm for given problem

This experiment focuses on implementing the EM algorithm for a given problem. Use the provided journal and notebook resources above for guidance and reference.
