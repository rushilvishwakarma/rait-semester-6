...
|  6 | Applications of Deep LearningImageNet Detection and classification, Audio generation using WaveNet, Natural Language Processing with Word2Vec, Bio-Informatics Face Recognition, Scene Understanding and sematic segmentation, Automated Image Captioning. | 06 | CO6  |
---
