...
<div className="grid gap-4 sm:grid-cols-2">
  ...
  />
    ...
    presentationLabel="Open Question Bank"
    href="https://drive.google.com/file/d/1iLZdUIYcEbotrxaDFkDbDNA7t7LurG4A/view?usp=drive_link"
    curatedLabel="View Solved (Unofficial)"
    curatedHref="/docs/core/curated/DL/MSE-QB"
    showAskAi={false}
  />
  <TheoryCard
    title="Internal Assessment 2"
    description="Modules 4 • Modules 5 • Applications"
    presentationLabel="Open Question Bank"
    href="https://drive.google.com/file/d/1XR-lXiRkM8N79y7wGU4dqa32k7gppmFj/view?usp=sharing"
    curatedLabel="View Solved (Unofficial)"
    curatedHref="/docs/core/curated/DL/IA2-QB"
    showAskAi={false}
  />
  <TheoryCard 
    title="End-Semester Exam (Theory)" 
    description="Modules 1 • Modules 2 • Modules 3 • Modules 4 • Modules 5 • Modules 6 (NOTE: Refer Numericals in IA2 Properly - NNFS-Based & Q20-21)"
    presentationLabel="Open Question Bank"
    href="https://drive.google.com/file/d/1EO5WMaSpY-mTB4CltT4pM_PQHKUsfVNj/view?usp=sharing"
    curatedLabel="View Solved (Unofficial)"
    curatedHref="/docs/core/curated/DL/ESE-QB"
    showAskAi={false}
  />
</div>
