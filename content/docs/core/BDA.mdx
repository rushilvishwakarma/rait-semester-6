...
<div className="grid gap-4 sm:grid-cols-2">
  <TheoryCard 
    ...
    description="Modules 1 • Modules 2 (MSE Question bank + Weekly question bank without questions from Module 3 onwards)"
    presentationLabel="Open Question Bank"
    curatedLabel="View Solved (Unofficial)"
    curatedHref="/docs/core/curated/BDA/IA1-QB"
    showAskAi={false}
  />
    <TheoryCard 
    title="Mid-Semester Exam" 
    description="Refer Internal Assessment 1 Question Bank for Q1-17. This contains Q18-28"
    presentationLabel="Open Question Bank"
    curatedLabel="View Solved (Unofficial)"
    curatedHref="/docs/core/curated/BDA/MSE-QB"
    showAskAi={false}
  />
    <TheoryCard
      title="BDA IA2 Resources"
      description="Topic-wise OCR resources for IA2 (Modules 4-5 focus)."
      curatedLabel="Open Resources"
      curatedHref="/docs/core/curated/BDA/IA2-Resources"
      showAskAi={false}
    />
    <TheoryCard 
      title="End-Semester Exam Notes" 
      description="Modules 1 • Modules 2 • Modules 3 • Modules 4 • Modules 5 • Modules 6"
      curatedLabel="View Notes"
      curatedHref="/docs/core/curated/BDA/ESE-QB"
      showAskAi={false}
    />
</div>
