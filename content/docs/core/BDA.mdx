...
<div className="grid gap-4 sm:grid-cols-2">
  <TheoryCard 
    ...
    href="https://drive.google.com/file/d/1e8Y4JKc42WN255kxLIos_NGX4qATOQu6/view?usp=sharing"
...
<div className="grid gap-4 sm:grid-cols-2">
  <TheoryCard 
    ...
    href="https://drive.google.com/file/d/173yYGNIYu1ILSdnycsWLLQND_062PSZV/view?usp=drive_link"
