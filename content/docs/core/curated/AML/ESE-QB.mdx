...
3. **Link Function**
   ...
   g(\mu) = \eta
   $$
   It **transforms** the expected value so it can be expressed as a linear function of predictors and keeps predictions within a valid range for the chosen distribution.
...
<LongQuestion>
### Q6. (Extras for Reference/Practice) Define the term "inference" in the context of probabilistic graphical models. List two common inference algorithms used in Bayesian Networks. / Describe inference in Bayesian Networks. Why is exact inference difficult in large networks? <QuestionDot color="yellow" text="IA1-QB" /> <QuestionDot color="green" text="Asked in IA1" />
</LongQuestion>
...
<LongQuestion>
### Q7. (Extras for Reference/Practice) Differentiate between Maximum Likelihood Estimation (MLE) and Bayesian Estimation for learning parameters in a directed graphical model. / Explain parameter learning in Directed Graphical Models. Differentiate between MLE and Bayesian estimation. <QuestionDot color="yellow" text="IA1-QB" /> <QuestionDot color="green" text="Asked in IA1" />
</LongQuestion>
