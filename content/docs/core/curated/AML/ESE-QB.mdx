...
Got it — here it is fully in **KaTeX `$$` format** and still minimal:

---

### Q1. Derive the Maximum Likelihood Estimates for the mean $\mu$ and variance $\sigma^2$
...
$$
\boxed{\hat{\mu}*{\text{MLE}} = \frac{1}{N}\sum*{i=1}^{N} y_i}
$$
